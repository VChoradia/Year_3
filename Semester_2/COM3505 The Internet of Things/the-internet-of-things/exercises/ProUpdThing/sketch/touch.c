...
static const int i = TOUCH_PAD_NUM6; // we're just using a single pin, T6
#elif CONFIG_IDF_TARGET_ESP32S2 || CONFIG_IDF_TARGET_ESP32S3
static const int i = TOUCH_PAD_NUM14; // we're just using a single pin, T14
#endif
...
#  if CONFIG_IDF_TARGET_ESP32
        ...
        //printf("%4d", touch_filter_value);
#  elif CONFIG_IDF_TARGET_ESP32S2 || CONFIG_IDF_TARGET_ESP32S3
        touch_pad_read_raw_data(i, &touch_value);    // read raw data.
        printf("T%d:[%4u] ", i, touch_value);
#  endif
#else
...
{
printf("configuring for touch pad %d\n", i);
#if CONFIG_IDF_TARGET_ESP32
