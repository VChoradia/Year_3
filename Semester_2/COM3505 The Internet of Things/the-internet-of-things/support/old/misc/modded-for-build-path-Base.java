...
PreferencesData.setBoolean("runtime.preserve.temp.files", true);
...
System.out.print("LB working dir: ");
System.out.println(System.getProperty("user.dir"));
System.out.print("LB sketch bin file output to: ");
String binPath = sketch.getBuildPath().getAbsolutePath() + File.separator + outputFile + ".bin";
System.out.println(binPath);
System.out.print("LB sketch bin prefix: ");
System.out.println(sketch.getBuildPath().getAbsolutePath());
System.out.print("LB sketch cache prefix: ");
System.out.println(BaseNoGui.getCachePath());
      } catch (Exception e) {
        // Error during build
        e.printStackTrace();
        System.exit(1);
